...
public class ChadmiumCompressorScreen extends AbstractContainerScreen<ChadmiumCompressorMenu> {
    private static final ResourceLocation TEXTURE = 
        new ResourceLocation(GigaTubes.MOD_ID, "textures/gui/chadmium_compressor.png");

    public ChadmiumCompressorScreen(ChadmiumCompressorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    private void renderProgressArrow(GuiGraphics graphics, int x, int y) {
        if (menu.isCrafting()) {
            graphics.blit(TEXTURE, x + 100, y + 44, 176, 0, menu.getScaledProgress(), 16);
        }
    }
}
